...
class MainActivityWithGlide : AppCompatActivity(), SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.actionBar.text = "Glide Image Loading"
        binding.glideSwitch.text = "Without Glide"
        binding.glideSwitch.setOnClickListener {
            startActivity(Intent(this, MainActivityWithCustomGlide::class.java))
            finish()
        }
    ...
    private fun setUpRecyclerView() {
        adapter = ImageRecyclerAdapter(this, true)
